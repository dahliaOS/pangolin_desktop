...
Text('You are on the latest version of dahliaOS, powered by Linux. This is a pre-release, and it will not be an indication of the final product. If you run into bugs, feel free to create an issue report on Github, Reddit, or Discord.',
                  style: TextStyle(fontSize: 15, color: Color(0xff000000))),
