...
Text('Welcome to dahliaOS!',
                  ...
                  Text('dahliaOS Linux-based rolling-prerelease v200630.1',//version string
                  style: TextStyle(fontSize: 15, color: Color(0xff000000))),
Text('You are on the latest version of dahliaOS, powered by Linux. This is a pre-release, and will not be indicative of a final product. If you run into bugs, feel free to create an issue report on Github, r/dahliaos, or Discord.',
                  style: TextStyle(fontSize: 15, color: Color(0xff000000))),
