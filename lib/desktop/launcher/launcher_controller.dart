...
class ApplicationsData extends ChangeNotifier {
  List<ApplicationData> applicationsData = [];
  List<ApplicationData> applicationsDataSearched = [];
  List<AppLauncherButton> applications = [];

  List<ApplicationData> get getApplicationsData => applicationsDataSearched;
  void initializeApps() {
    // getter of apps data
